...
import { EventManifest } from "@cloudpilot-ai/schema/event-manifest"
import { Location } from "@cloudpilot-ai/schema/location"
import type { Definition } from "@cloudpilot-ai/schema/event"
...
export const CloudPilotEvent = event.schema
export type CloudPilotEvent = typeof CloudPilotEvent.Type
export type CloudPilotEventEncoded = typeof CloudPilotEvent.Encoded
