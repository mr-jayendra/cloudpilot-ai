...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new CloudpilotClient()" to fix this error.`)
    }
    return instance
  }
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the CloudPilot system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the CloudPilot system.
   */
...
export class Capabilities extends HeyApiClient {
   ...
   *
   * Get experimental features enabled on the CloudPilot server.
   */
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local CloudPilot state.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global CloudPilot configuration settings and preferences.
   */
   ...
   *
   * Update global CloudPilot configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the CloudPilot server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the CloudPilot system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all CloudPilot instances, releasing all resources.
   */
   ...
   * Upgrade cloudpilot
   *
   * Upgrade cloudpilot to the specified version.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current CloudPilot configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update CloudPilot configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current CloudPilot instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the CloudPilot system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with CloudPilot.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that CloudPilot is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by CloudPilot.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all CloudPilot sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new CloudPilot session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific CloudPilot session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class Session3 extends HeyApiClient {
   ...
   *
   * Interrupt active execution owned by this CloudPilot process. Idle interruption is a no-op.
   */
...
export class CloudpilotClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<CloudpilotClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    CloudpilotClient.__registry.set(this, args?.key)
  }
