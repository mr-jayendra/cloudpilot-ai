...
import cloudpilot from "./assets/cloudpilot.json" with { type: "json" }
...
export type Theme = {
  ...
  readonly backgroundSelected: RGBA
...
export type ThemeJson = {
  ...
  theme: Omit<Record<ThemeColor, ColorValue>, "selectedListItemText" | "backgroundMenu" | "backgroundSelected"> & {
...
export function resolveTheme(theme: ThemeJson, mode: "dark" | "light") {
  ...
  // Handle backgroundSelected - optional with fallback to primary so existing
  // themes keep their current selection highlight.
  if (theme.theme.backgroundSelected !== undefined) {
    resolved.backgroundSelected = resolveColor(theme.theme.backgroundSelected)
  } else {
    resolved.backgroundSelected = resolved.primary
  }
