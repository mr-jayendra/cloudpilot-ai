...
import { CLOUDPILOT_BASE_MODE, useBindings, useCommandShortcut, useCloudpilotKeymap } from "../../keymap"
...
const GO_UPSELL_PROVIDERS = new Set(["cloudpilot", "cloudpilot-go"])
