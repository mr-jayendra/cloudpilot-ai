...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "CLOUDPILOT.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/cloudpilot-ai/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/cloudpilot-ai (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/cloudpilot-ai/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/cloudpilot-ai/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const CLOUDPILOT_DB|CLOUDPILOT_DB|CLOUDPILOT_DEV|Global\\.Path\\.data|data =" in packages/cloudpilot-ai/src (115 matches)',
  },
] as const
