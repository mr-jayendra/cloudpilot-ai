...
test("parses valid share URLs", () => {
  expect(parseShareUrl("https://mr-jayendra.github.io/cloudpilot-ai/share/Jsj3hNIW")).toBe("Jsj3hNIW")
...
test("rejects invalid URLs", () => {
  expect(parseShareUrl("https://mr-jayendra.github.io/cloudpilot-ai/s/Jsj3hNIW")).toBeNull() // legacy format
  expect(parseShareUrl("https://mr-jayendra.github.io/cloudpilot-ai/share/")).toBeNull()
  expect(parseShareUrl("https://mr-jayendra.github.io/cloudpilot-ai/share/id/extra")).toBeNull()
