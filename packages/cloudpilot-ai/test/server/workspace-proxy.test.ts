...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips cloudpilot-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-cloudpilot-directory"]).toBeUndefined()
      expect(forwarded["x-cloudpilot-workspace"]).toBeUndefined()
