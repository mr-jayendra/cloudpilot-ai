...
const stateLayer = Layer.effectDiscard(
  Effect.gen(function* () {
    const original = {
      CLOUDPILOT_EXPERIMENTAL_WORKSPACES: Flag.CLOUDPILOT_EXPERIMENTAL_WORKSPACES,
    }
    ...
    yield* Effect.addFinalizer(() =>
      Effect.promise(async () => {
        Flag.CLOUDPILOT_EXPERIMENTAL_WORKSPACES = original.CLOUDPILOT_EXPERIMENTAL_WORKSPACES
        await resetDatabase()
      }),
    )
  }),
