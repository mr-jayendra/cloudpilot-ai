...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips cloudpilot-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-cloudpilot-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-cloudpilot-directory")).toBeNull()
      expect(result.get("x-cloudpilot-workspace")).toBeNull()
