  ...
  it.instance(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const headers = { "x-cloudpilot-directory": tmp.directory, "content-type": "application/json" }
        ...
        const response = yield* Effect.promise(() =>
          HttpApiApp.webHandler().handler(
            new Request(`http://localhost${SyncPaths.history}`, {
              method: "POST",
              headers: { "x-cloudpilot-directory": tmp.directory, "content-type": "application/json" },
