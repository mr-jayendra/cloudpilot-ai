...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders CLOUDPILOT_CALLER", () => {
    process.env["CLOUDPILOT_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode CLOUDPILOT_CALLER", () => {
    process.env["CLOUDPILOT_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown CLOUDPILOT_CALLER", () => {
    process.env["CLOUDPILOT_CALLER"] = "unknown"
