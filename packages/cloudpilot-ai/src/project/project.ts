...
import { ProjectDirectoryTable, ProjectTable } from "@cloudpilot-ai/core/project/sql"
import { ProjectDirectories } from "@cloudpilot-ai/core/project/directories"
...
import { which } from "@cloudpilot-ai/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@cloudpilot/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.CLOUDPILOT_FAKE_VCS)
