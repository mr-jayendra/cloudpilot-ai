...
export class Service extends Context.Service<Service, Interface>()("@cloudpilot/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __CLOUDPILOT_PHOTON_WASM_PATH?: string }).__CLOUDPILOT_PHOTON_WASM_PATH =
