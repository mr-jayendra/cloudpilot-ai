 ...
 *   "@cloudpilot/ServerAuthConfig",
 *   {
 *     password: Config.string("CLOUDPILOT_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("CLOUDPILOT_SERVER_USERNAME").pipe(Config.withDefault("cloudpilot")),
 *   },
 * ) {}
 *
