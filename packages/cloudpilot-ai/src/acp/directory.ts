...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@cloudpilot/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@cloudpilot/ACPDirectory") {}
