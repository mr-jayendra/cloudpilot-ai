...
import type { AssistantMessage as CloudPilotAssistantMessage, Message } from "@cloudpilot-ai/sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@cloudpilot-ai/core/effect/app-node"
...
export type AssistantTokenCost = Pick<CloudPilotAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<CloudPilotAssistantMessage, "role"> &
  Partial<Pick<CloudPilotAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@cloudpilot/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@cloudpilot/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@cloudpilot/ACPUsage") {}
