...
>()("@cloudpilot/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@cloudpilot/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.CLOUDPILOT_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.CLOUDPILOT_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-cloudpilot-directory"] || process.cwd()
}
