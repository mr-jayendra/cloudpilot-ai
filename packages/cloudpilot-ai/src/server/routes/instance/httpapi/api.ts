...
import { makeApi } from "@cloudpilot-ai/protocol/api"
import { LocationMiddleware } from "@cloudpilot-ai/server/location"
import { SessionLocationMiddleware } from "@cloudpilot-ai/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("cloudpilot-root")
...
export const InstanceHttpApi = HttpApi.make("cloudpilot-instance")
...
export const CloudPilotHttpApi = HttpApi.make("cloudpilot")
