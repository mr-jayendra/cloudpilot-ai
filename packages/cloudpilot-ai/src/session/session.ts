...
import { Slug } from "@cloudpilot-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@cloudpilot-ai/llm"
...
import { locationServiceMapLayer } from "@cloudpilot-ai/core/location-services"
...
import { PartTable, SessionTable } from "@cloudpilot-ai/core/session/sql"
...
import { NonNegativeInt, optional } from "@cloudpilot-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".cloudpilot", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@cloudpilot/Session") {}
