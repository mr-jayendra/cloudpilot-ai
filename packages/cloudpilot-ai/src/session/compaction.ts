...
import { buildPrompt } from "@cloudpilot-ai/core/session/compaction"
import { SessionCompactionEvent } from "@cloudpilot-ai/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@cloudpilot/SessionCompaction") {}
