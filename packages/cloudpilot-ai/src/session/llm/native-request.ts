import type { JsonSchema, LLMRequest, ProviderMetadata } from "@cloudpilot-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@cloudpilot-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @cloudpilot-ai/llm request objects from cloudpilot's session/AI SDK-shaped data.
  return LLM.request({
