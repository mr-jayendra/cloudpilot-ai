...
const USER_AGENT = `cloudpilot/${InstallationVersion}`
...
export const prepare = Effect.fn("LLMRequestPrep.prepare")(function* (input: PrepareInput) {
  ...
  const cloudpilotProjectID = input.model.providerID.startsWith("cloudpilot")
  ...
  return {
    ...
    headers: {
      ...(input.model.providerID.startsWith("cloudpilot")
        ? {
