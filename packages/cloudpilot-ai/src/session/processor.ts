...
import { Usage, type LLMEvent } from "@cloudpilot-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@cloudpilot/SessionProcessor") {}
      ...
      const handleEvent = Effect.fnUntraced(function* (value: StreamEvent) {
        switch (value.type) {
          ...
          case "step-finish": {
            ...
            // prompt. Prefix mismatches mean cloudpilot changed history behind a signed
