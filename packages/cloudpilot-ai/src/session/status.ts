...
import { SessionStatusEvent } from "@cloudpilot-ai/schema/session-status-event"
...
export class Service extends Context.Service<Service, Interface>()("@cloudpilot/SessionStatus") {}
