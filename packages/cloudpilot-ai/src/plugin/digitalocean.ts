import type { Hooks, PluginInput } from "@cloudpilot-ai/plugin"
import type { Model } from "@cloudpilot-ai/sdk/v2"
import { InstallationVersion } from "@cloudpilot-ai/core/installation/version"
import { OauthCallbackPage } from "@cloudpilot-ai/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. CloudPilot will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
