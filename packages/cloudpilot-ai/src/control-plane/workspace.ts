...
import { EventSequenceTable, EventTable } from "@cloudpilot-ai/core/event/sql"
...
import { WorkspaceEvent } from "@cloudpilot-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@cloudpilot/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        CLOUDPILOT_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        CLOUDPILOT_WORKSPACE_ID: config.id,
        CLOUDPILOT_EXPERIMENTAL_WORKSPACES: "true",
