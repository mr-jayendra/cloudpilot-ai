...
import { AccountStateTable, AccountTable } from "@cloudpilot-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@cloudpilot/AccountRepo") {}
