...
import { checksum } from "@cloudpilot-ai/core/util/encode"
...
export function selectWebSearchProvider(sessionID: string, flags = { exa: false, parallel: false }): WebSearchProvider {
  const override = process.env.CLOUDPILOT_WEBSEARCH_PROVIDER
...
function parallelAuthHeaders() {
  const headers = { "User-Agent": `cloudpilot/${InstallationVersion}` }
