...
import { openEditor } from "@cloudpilot-ai/tui/editor"
import { registerCloudpilotKeymap } from "@cloudpilot-ai/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerCloudpilotKeymap(keymap, renderer, input.tuiConfig)
