...
import { normalizePromptContent } from "@cloudpilot-ai/tui/editor"
...
import { CLOUDPILOT_BASE_MODE, useBindings } from "@cloudpilot-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close CloudPilot" } satisfies SlashOption,
    ]
