...
import type { Event, GlobalEvent, CloudpilotClient } from "@cloudpilot-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@cloudpilot/RunStreamTransport") {}
