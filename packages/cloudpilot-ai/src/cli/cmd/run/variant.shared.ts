...
//
// The saved variant persists across sessions in ~/.local/state/cloudpilot/model.json
...
class Service extends Context.Service<Service, VariantService>()("@cloudpilot/RunVariant") {}
