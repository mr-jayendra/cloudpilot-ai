...
- Effect plugins import `@cloudpilot-ai/plugin/v2/effect`, not `@cloudpilot-ai/core`.
- Public domain values use generated `@cloudpilot-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@cloudpilot-ai/plugin/v2/effect`.
