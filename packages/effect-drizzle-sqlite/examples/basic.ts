...
class Database extends Context.Service<Database, DatabaseShape>()("@cloudpilot/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@cloudpilot/example/UserStore") {
