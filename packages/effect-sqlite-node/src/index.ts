...
export const TypeId: TypeId = "~@cloudpilot-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@cloudpilot-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@cloudpilot-ai/effect-sqlite-node/NodeSqliteClient")
