...
import type { Plugin as PluginRuntime } from "@cloudpilot-ai/plugin/v2/effect"
...
export class Service extends Context.Service<Service, Interface>()("@cloudpilot/v2/Plugin") {}
