...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@cloudpilot-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@cloudpilot/v2/ToolRegistry") {}
