...
import { Event } from "@cloudpilot-ai/schema/project-directories"
import { ProjectCopy } from "@cloudpilot-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@cloudpilot/ProjectCopy") {}
