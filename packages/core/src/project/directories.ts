...
import type { EffectDrizzleSqlite } from "@cloudpilot-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@cloudpilot/ProjectDirectories") {}
