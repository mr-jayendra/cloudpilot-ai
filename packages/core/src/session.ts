...
import { ListAnchor } from "@cloudpilot-ai/schema/session"
...
import { SessionDurable } from "@cloudpilot-ai/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@cloudpilot/v2/Session") {}
