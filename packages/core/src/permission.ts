...
export { Effect, Rule, Ruleset } from "@cloudpilot-ai/schema/permission"
...
export class Service extends Context.Service<Service, Interface>()("@cloudpilot/v2/Permission") {}
