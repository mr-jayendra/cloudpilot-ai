...
import type { Data, Definition, Payload } from "@cloudpilot-ai/schema/event"
...
import { Durable } from "@cloudpilot-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@cloudpilot-ai/schema/event").ID
export type { Data, Definition, Payload } from "@cloudpilot-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@cloudpilot/Event") {}
