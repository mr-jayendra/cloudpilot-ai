...
import { FileSystemWatcher } from "@cloudpilot-ai/schema/filesystem-watcher"
...
declare const CLOUDPILOT_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof CLOUDPILOT_LIBC === "undefined" ? undefined : CLOUDPILOT_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@cloudpilot/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.CLOUDPILOT_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.CLOUDPILOT_EXPERIMENTAL_FILEWATCHER)) {
