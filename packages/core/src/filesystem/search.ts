...
import { Entry, Match } from "@cloudpilot-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@cloudpilot/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.CLOUDPILOT_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
