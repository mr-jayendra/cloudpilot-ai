...
import { Entry, FileSystem, FindInput, Match } from "@cloudpilot-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@cloudpilot-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@cloudpilot/v2/FileSystem") {}
