...
import { ProviderPlugins } from "@cloudpilot-ai/core/plugin/provider"
import { ZenmuxPlugin } from "@cloudpilot-ai/core/plugin/provider/zenmux"
...
describe("ZenmuxPlugin", () => {
  ...
  it.effect("applies the exact legacy Zenmux headers", () =>
    Effect.gen(function* () {
      ...
      expect(result.request.headers).toEqual({ "HTTP-Referer": "https://mr-jayendra.github.io/cloudpilot-ai/", "X-Title": "cloudpilot" })
