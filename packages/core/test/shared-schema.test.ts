...
import { ModelV2 } from "@cloudpilot-ai/core/model"
import { SessionV2 } from "@cloudpilot-ai/core/session"
import { Agent } from "@cloudpilot-ai/schema/agent"
import { Location } from "@cloudpilot-ai/schema/location"
import { Model } from "@cloudpilot-ai/schema/model"
import { AgentAttachment, FileAttachment, Prompt, Source } from "@cloudpilot-ai/schema/prompt"
import { Provider } from "@cloudpilot-ai/schema/provider"
import { Project } from "@cloudpilot-ai/schema/project"
import { ProjectDirectories } from "@cloudpilot-ai/schema/project-directories"
import { PermissionV1 } from "@cloudpilot-ai/schema/permission-v1"
import { Session } from "@cloudpilot-ai/schema/session"
import { SessionInput } from "@cloudpilot-ai/schema/session-input"
import { SessionMessage } from "@cloudpilot-ai/schema/session-message"
import { Workspace } from "@cloudpilot-ai/schema/workspace"
import { Command } from "@cloudpilot-ai/schema/command"
import { Connection } from "@cloudpilot-ai/schema/connection"
import { Credential } from "@cloudpilot-ai/schema/credential"
import { FileSystem } from "@cloudpilot-ai/schema/filesystem"
import { Integration } from "@cloudpilot-ai/schema/integration"
import { LLM } from "@cloudpilot-ai/schema/llm"
import { Permission } from "@cloudpilot-ai/schema/permission"
import { Plugin } from "@cloudpilot-ai/schema/plugin"
import { Pty } from "@cloudpilot-ai/schema/pty"
import { Reference } from "@cloudpilot-ai/schema/reference"
import { SessionTodo } from "@cloudpilot-ai/schema/session-todo"
import { Skill } from "@cloudpilot-ai/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@cloudpilot-ai/schema/schema"
import { ProviderV2 } from "@cloudpilot-ai/core/provider"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@cloudpilot-ai/core/command"),
    import("@cloudpilot-ai/core/integration/connection"),
    import("@cloudpilot-ai/core/credential"),
    import("@cloudpilot-ai/core/filesystem"),
    import("@cloudpilot-ai/core/integration"),
    import("@cloudpilot-ai/core/location"),
    import("@cloudpilot-ai/llm"),
    import("@cloudpilot-ai/core/permission"),
    import("@cloudpilot-ai/core/v1/permission"),
    import("@cloudpilot-ai/core/project/copy"),
    import("@cloudpilot-ai/core/pty"),
    import("@cloudpilot-ai/core/project/schema"),
    import("@cloudpilot-ai/core/reference"),
    import("@cloudpilot-ai/core/session/input"),
    import("@cloudpilot-ai/core/session/message"),
    import("@cloudpilot-ai/core/session/todo"),
    import("@cloudpilot-ai/core/session/prompt"),
    import("@cloudpilot-ai/core/skill"),
    import("@cloudpilot-ai/core/v2-schema"),
    import("@cloudpilot-ai/core/schema"),
    import("@cloudpilot-ai/core/workspace"),
  ])
