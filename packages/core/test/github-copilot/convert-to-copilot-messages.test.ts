import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@cloudpilot-ai/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
