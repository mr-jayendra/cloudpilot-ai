...
import { LLM, LLMClient, Message, ProviderID, Tool, ToolRuntime } from "@cloudpilot-ai/llm"
import { Route, Auth, Endpoint, Framing, Protocol, RequestExecutor, WebSocketExecutor } from "@cloudpilot-ai/llm/route"
import { OpenAI } from "@cloudpilot-ai/llm/providers"
...
const rawOverlayExample = LLM.request({
  ...
  http: {
    ...
    headers: { "x-cloudpilot-tutorial": "1" },
    query: { debug: "1" },
  },
})
