...
> current private `@cloudpilot-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@cloudpilot-ai/ai`
...
- Secondary audience: CloudPilot and other durable agent runtimes
...
import { LLM } from "@cloudpilot-ai/ai"
import { OpenAI } from "@cloudpilot-ai/ai/providers/openai"
...
```ts
import { Message } from "@cloudpilot-ai/ai"
...
import { LLM, Tool } from "@cloudpilot-ai/ai"
...
CloudPilot and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@cloudpilot-ai/ai/promise"
import { OpenAI } from "@cloudpilot-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@cloudpilot-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@cloudpilot-ai/ai/provider"
...
@cloudpilot-ai/ai/promise
  Promise/AsyncIterable LLM facade

@cloudpilot-ai/ai/schema
  serializable domain schemas

@cloudpilot-ai/ai/provider
  experimental Provider and Protocol authoring APIs

@cloudpilot-ai/ai/providers/openai
@cloudpilot-ai/ai/providers/anthropic
@cloudpilot-ai/ai/providers/google
...
```
...
| Current                                 | Proposed                                                    |
| --------------------------------------- | ----------------------------------------------------------- |
| `@cloudpilot-ai/llm`                      | `@cloudpilot-ai/ai`                                           |
...
CloudPilot should migrate to `generateTurn` / `streamTurn`, preserving its durable
