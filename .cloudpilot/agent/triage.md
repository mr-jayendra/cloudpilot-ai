...
Desktop application and browser-based app issues, including `cloudpilot web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core cloudpilot server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

CloudPilot Zen, CloudPilot Go, and billing issues.
