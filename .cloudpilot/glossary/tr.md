...
- `CloudPilot` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `cloudpilot` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `CloudPilot` in prose, `cloudpilot` only for exact technical identifiers
...
- Avoid changing `cloudpilot` to `CloudPilot` inside commands, URLs, package names, or code literals
