...
- `CloudPilot` (preserve casing in prose; keep `cloudpilot` only when it is part of commands, package names, paths, or code)
- `CloudPilot Zen`
- `CloudPilot CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `cloudpilot` in prose when referring to the product name; use `CloudPilot`
